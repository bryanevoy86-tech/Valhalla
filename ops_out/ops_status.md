# Valhalla Headless Ops Status
- Generated (UTC): `2026-01-25T20:32:07+00:00`
- API Base: `https://valhalla-api-ha6a.onrender.com`

## What to do next (single source)
- All checks green. Proceed with your next operational step (intake/leads/testing) as planned.

## Health
- URL: `https://valhalla-api-ha6a.onrender.com/health`
- OK: `True`
- Status: `200`
...
- URL: `https://valhalla-api-ha6a.onrender.com/api/governance/runbook/status`
- OK: `True`
- Status: `200`
- Content-Type: `application/json`
...
```json
{
  "generated_at": "2026-01-25T20:32:07.485187Z",
  "blockers": [],
  "warnings": [],
  "info": [
    {
    ...
    },
    {
      ...
      "detail": {
        ...
        "updated_at": "2026-01-17 05:21:23.147475"
      }
    },
    {
      "id": "env_sanity",
