...
def upgrade():
    ...
    if not _table_exists(bind, 'philosophy_records'):
        op.create_table(
            'philosophy_records',
    ...
    if not _table_exists(bind, 'empire_principles'):
        op.create_table(
            'empire_principles',
            sa.Column('id', sa.Integer(), nullable=False),
    ...
    if not _table_exists(bind, 'relationship_profiles'):
        op.create_table(
    ...
    if not _table_exists(bind, 'trust_event_logs'):
        op.create_table(
            'trust_event_logs',
            sa.Column('id', sa.Integer(), nullable=False),
    ...
    if not _table_exists(bind, 'daily_rhythm_profiles'):
        op.create_table(
    ...
    if not _table_exists(bind, 'tempo_rules'):
        op.create_table(
            'tempo_rules',
            sa.Column('id', sa.Integer(), nullable=False),
