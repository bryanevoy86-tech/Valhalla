...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('stage_2_complete', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        ...
        sa.Column('stage_3_complete', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        ...
        sa.Column('stage_4_complete', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        ...
        sa.Column('stage_5_complete', sa.Boolean(), nullable=False, server_default=sa.text("false")),
