...
def upgrade():
    ...
    if _table_exists(bind, "seller_profiles"):
    ...
    if _table_exists(bind, "script_blocks"):
    ...
    if _table_exists(bind, "playbooks"):
    ...
    if _table_exists(bind, "closer_sessions"):
    ...
    if _table_exists(bind, "closer_events"):
