...
def upgrade() -> None:
    ...
    if not table_exists('execution_cases'):
        op.create_table(
            'execution_cases',
    ...
    if not table_exists('execution_events'):
        op.create_table(
            'execution_events',
            sa.Column('id', sa.Integer(), nullable=False, primary_key=True),
    ...
    if not table_exists('execution_policies'):
        op.create_table(
            'execution_policies',
            sa.Column('id', sa.Integer(), nullable=False, primary_key=True),
    ...
    if not table_exists('underwriter_assessments'):
        op.create_table(
...
def downgrade() -> None:
    ...
    if table_exists('tasks'):
        op.drop_table('tasks')
    if table_exists('underwriter_assessments'):
        op.drop_table('underwriter_assessments')
    if table_exists('execution_policies'):
        op.drop_table('execution_policies')
    if table_exists('execution_events'):
        op.drop_table('execution_events')
    if table_exists('execution_cases'):
