...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('business_allowed', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column('personal_allowed', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column('notes', sa.Text(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
    ...
    op.create_table(
        ...
        sa.Column('rule_compliant', sa.Boolean(), nullable=False, server_default=sa.text("true")),
    ...
    op.create_table(
        ...
        sa.Column('business_use', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column('personal_use', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column('mixed_use', sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column('business_related', sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column('gaps_identified', sa.Boolean(), nullable=False, server_default=sa.text("false")),
